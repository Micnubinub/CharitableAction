...
package bigshots.people_helping_people.schedule_wheel;
...
import bigshots.people_helping_people.schedule_wheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
     ...
     * @param defStyle The default style to apply to this view.
     */
    void initAttributes(AttributeSet attrs, int defStyle) {
        mVisibleItems = 3;
        mIsAllVisible = false;
        mIsCyclic = true;
     ...
     */
    void invalidateItemsLayout(boolean clearCaches) {
        if (clearCaches) {
            mRecycler.clearAll();
     ...
     */
    boolean isValidItemIndex(int index) {
